...
export const InstructorSection = () => {
  const achievements = ["Certified Amazon FBA Expert", "Best Ecommerce Training in Pakistan", "Thousands Learn Online Business", "Proven Digital Marketing Course Success"];
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-12 sm:mb-16 animate-fade-in">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-muted-foreground max-w-2xl mx-auto px-2">
            Learn from Pakistan's leading expert in Amazon FBA course, dropshipping in Urdu, and digital marketing who has helped thousands start successful ecommerce stores and make money online
          </p>
        </div>
            ...
            <div className="grid lg:grid-cols-2 gap-0">
              ...
              <div className="relative">
                <img 
                  ...
                  alt="Anas - Expert instructor for Amazon FBA course in Pakistan, dropshipping in Urdu, and digital marketing training at Ecommerence Excellence Academy" 
              ...
              <div className="p-4 sm:p-6 lg:p-8 xl:p-12 flex flex-col justify-center">
                <div className="animate-fade-in">
                  ...
                  <p className="text-sm sm:text-base lg:text-lg text-muted-foreground leading-relaxed mb-6 sm:mb-8">
                    Anas is a certified ecommerce expert specializing in Amazon FBA course in Pakistan and dropshipping in Urdu. 
                    With years of experience in digital marketing course delivery, he has helped thousands of students learn online business, 
                    start ecommerce stores, and make money online through freelancing and ecommerce ventures.
                  </p>
